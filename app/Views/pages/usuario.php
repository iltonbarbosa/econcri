	...
	<div class="row">
		<div class="col-md-6">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('Usuario/gravar') ?>" method="post">
					...
					<p>O primeiro passo é fazer este cadastro inicial. Em seguida faça o seu cadastro como artista da cidade.
					Você pode inclusive cadastrar outros artistas que conhecer, ajudando assim a fazer dessa base de dados uma fonte de informação cada vez mais abrangente.</>
				</div>
			</div>
		</div>
	</div>
